...
import 'package:room_booking/app/constants/app.theme.dart';
import 'package:room_booking/app/provider/app.provider.dart';
import 'package:room_booking/app/routes/app.routes.dart';
import 'package:room_booking/core/notifiers/theme.notifier.dart';
import 'package:room_booking/core/service/network.service.dart';
    ...
    return Consumer<ThemeNotifier>(
      builder: (context, notifier, _) {
        return MaterialApp(
          ...
          debugShowCheckedModeBanner: false,
          onGenerateRoute: AppRouter.generateRoute,
          initialRoute: AppRouter.splashRoute, //Here, we set the initial route for the app...
        );
      },
    );
  }
