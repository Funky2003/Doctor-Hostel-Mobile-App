...
import 'package:room_booking/presentation/screens/prevBookingScreen/widgets/booking.item.dart';
...
class PreviousBookingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AuthenticationNotifer _auth = Provider.of<AuthenticationNotifer>(context, listen: false);
