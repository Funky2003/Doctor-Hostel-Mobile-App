...
import 'package:room_booking/app/constants/app.keys.dart';
...
import 'package:room_booking/core/service/cache.service.dart';
import 'package:room_booking/presentation/screens/profileScreen/profile.screen.dart';
import 'package:room_booking/presentation/screens/settingScreen/widgets/icon.style.dart';
import 'package:room_booking/presentation/screens/settingScreen/widgets/setting.item.dart';
import 'package:room_booking/presentation/screens/settingScreen/widgets/setting.user.card.dart';
import 'package:room_booking/presentation/screens/settingScreen/widgets/setting.appbar.dart';
        ...
        child: Column(
          children: [
            ...
            UserCard(
              ...
              userName: userData.userName!,//<---I used the question marks to run a null check the data--->
              userProfileUrl: userData.userPhoto!,//<---I used the question marks to run a null check the data--->
              onTap: () {},
            ),
            SizedBox(
              height: 10,
            ...
            SettingsItem(
              onTap: () async {
                final Uri _url = Uri.parse('https://www.devadnani.com/pPolicy.html');
                launchUrl(_url);
              },
              themeFlag: themeFlag,
            ...
            SettingsItem(
              ...
              title: 'About',
              subtitle: "Learn more about Doctor Hostel App",
            ),
            SettingsItem(
              themeFlag: themeFlag,
              onTap: () {
              ...
              title: 'Send Feedback',
              subtitle: "We Listen To Our Customers",
            ),
            SettingsItem(
              themeFlag: themeFlag,
              onTap: () {
