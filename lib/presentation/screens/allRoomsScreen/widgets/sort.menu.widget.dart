  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton2(
        ...
        //...THIS WAS COMMENTED BECAUSE THE NEW VERSION DO NOT SUPPORT THE VALUES...//
...
class MenuItems {
  ...
  static onChanged(BuildContext context, MenuItem item) {
    switch (item) {
      case MenuItems.up:
        Provider.of<SortNotifier>(context, listen: false).changeByAscendingOrder();
        break;
      case MenuItems.down:
        Provider.of<SortNotifier>(context, listen: false).changeByDescendingOrder();
        break;
    }
  }
}
