...
import 'package:room_booking/presentation/widgets/loading.dialog.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    PhotoService _photoService = Provider.of<PhotoService>(context, listen: true);
                  ...
                  child: Stack(
                    children: [
                      Container(
                        width: 150.0,
                        height: 150.0,
                        child: _photoService.image == null ? ClipRRect(
