...
class RoomModel {
  ...
  factory RoomModel.fromJson(Map<String, dynamic> json) => RoomModel(
        ...
        roomAmenitiesText: List<String>.from(json["room_amenities_text"].map((x) => x)),
        roomAmenitiesImages: List<String>.from(json["room_amenities_image"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "room_amenities_image": List<dynamic>.from(roomAmenitiesImages.map((x) => x)),
